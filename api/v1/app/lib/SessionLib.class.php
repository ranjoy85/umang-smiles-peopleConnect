<?php
	namespace PeopleConnect\Session;
    ...
    class SessionLib {
		...
		public function sendBackToClient($DBAccessLib, $UtilityLib, $user_id, $keyName, $data)
		{
			...
			$updatedtudilLoggedInSessionId = $this->updateSession($DBAccessLib, $UtilityLib, $user_id); 
			
			if($updatedtudilLoggedInSessionId == "NO_SESSION")
			{
			...
			else
			{
				...
				$responseData['updatedLoggedInSessionId']  = $updatedtudilLoggedInSessionId;
			}
